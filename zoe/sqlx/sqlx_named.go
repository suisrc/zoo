...
func bindAnyArgs(names []string, arg any, m *Mapper) ([]any, error) {
...
func bindArgs(names []string, arg any, m *Mapper) ([]any, error) {
	...
	err := m.TraversalsByNameFunc(v.Type(), names, func(i int, t []int) error {
		...
		val := FieldByIndexesReadOnly(v, t)
...
func bindStruct(bindType int, query string, arg any, m *Mapper) (string, []any, error) {
...
// structs argument.
func bindArray(bindType int, query string, arg any, m *Mapper) (string, []any, error) {
...
func bindNamedMapper(bindType int, query string, arg any, m *Mapper) (string, []any, error) {
